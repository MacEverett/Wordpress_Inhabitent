 ...
 * @author    Your Name <maceverett3@gmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2015 Macdaddy WD
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:        http://redacademy.com
 * Description:       buisnes hours widget for the Inhabitent project
 * Version:           1.0.0
 * Author:            Mac Everett
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Dynmaically Displays The Hours of Your Business To Connect With Customers n a Deep Level'
			)
		);
